package server.userinterface.mazeFX;/**
...
import server.generated.CardType;
import server.generated.MoveMessageType;
import server.generated.PositionType;
import server.Board;
import server.Card;
import server.Game;
...
import server.userinterface.mazeFX.objects.CardFX;
import server.userinterface.mazeFX.objects.PlayerFX;
import server.userinterface.mazeFX.util.FakeTranslateBinding;
import server.userinterface.mazeFX.util.Translate3D;
